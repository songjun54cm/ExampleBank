...
if __name__ == '__main__':
    ...
    train = pd.read_csv('G://Datasets//avazuCTR//train.csv', chunksize=100)

    test = pd.read_csv('G://Datasets//avazuCTR//test.csv', chunksize=100)
    ...
    with open(os.path.join(DATA_DIR, "dicts", 'click.pkl'), 'rb') as f:
        click = pickle.load(f)

    train_array_length = max(click.values()) + 1
