...
public class Inherit {
    public static void main(String[] args){
        ...
        System.out.println("SubClass1 name: " + s1.getName());
        System.out.println("SubClass1 sex: " + s1.getSex());
        System.out.println("SubClass1 static: " + s1.getStaticStr());
        System.out.println("SubClass2 name: " + s1.getName());
        System.out.println("SubClass2 sex: " + s1.getSex());
        System.out.println("SubClass2 static: " + s1.getStaticStr());
...
class SubClass1 extends SuperClass{
    ...
    public SubClass1(String label){
        super("inSub1");
        System.out.println("SubClass1(label):"+label);
        this.label = label;
    }
...
class SubClass2 extends SuperClass{
    ...
    public SubClass2(String label){
        super("inSub2");
        System.out.println("SubClass2(label):"+label);
        this.label = label;
    }
}